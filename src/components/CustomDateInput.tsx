...
import styles from '../styles/CustomDateInput.module.scss';
...
const CustomDateInput = (props: CustomDateInputProps, ref: React.Ref<HTMLInputElement>) => {
